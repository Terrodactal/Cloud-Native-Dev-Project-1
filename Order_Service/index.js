...
try{
    ...
    const paymentResponse = await axios.post('http://localhost:5002/paymentprocess')
    ...
    const notificationResponse = await axios.post('http://localhost:5000/sendnotification', {
